...
// SwaggerInfohistory holds exported Swagger Info so clients can modify it
var SwaggerInfohistory = &swag.Spec{
	Version:          "1.0 版本",
	Host:             "",
	...
	Title:            "历史数据接口文档",
	Description:      "API文档",
	InfoInstanceName: "history",
	SwaggerTemplate:  docTemplatehistory,
}

func init() {
	swag.Register(SwaggerInfohistory.InstanceName(), SwaggerInfohistory)
}
